...
?>
<div class="row row-cols-1 row-cols-lg-1 mt-2 mr-3 ml-3" id="order-detail">
    <div class="col mb-3">
        <div class="card border-warning h-100">
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-auto">
                        <img src="<?= Yii::getAlias('@img') ?>/order.png">
                    </div>
                    <div class="col">
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <div class="row">
                                    <div class="col block rounded mr-3 ml-3 mb-4 pl-1 pr-2 pt-3">
                                        <ul>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="row">
                                    <div class="col block rounded mr-3 ml-3 mb-4 pl-3 pr-3 pt-3">
                                ...
                                <div class="row">
                                    <div class="col block rounded mr-3 ml-3 mb-4 pl-3 pr-3 pt-3">
                                        ...
                                        <div id="condition">
                                            ...
                                            <ul>
                                                <li>Аванс 30%</li>
                                                <li>По желанию, заключается договор с физическим лицом на оказание услуг (+13% к сумме договора)</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
